...
public class InternalStatusLexer extends Lexer {
    ...
    public final void mRULE_LONG() throws RecognitionException {
        try {
            int _type = RULE_LONG;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStatus.g:2220:11: ( ( '0' .. '9' )+ )
            // InternalStatus.g:2220:13: ( '0' .. '9' )+
            {
            // InternalStatus.g:2220:13: ( '0' .. '9' )+
            int cnt1=0;
            loop1:
    ...
    public final void mRULE_BOOL() throws RecognitionException {
        try {
            int _type = RULE_BOOL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStatus.g:2222:11: ( ( 'true' | 'false' ) )
            // InternalStatus.g:2222:13: ( 'true' | 'false' )
            {
            // InternalStatus.g:2222:13: ( 'true' | 'false' )
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalStatus.g:2222:21: 'false'
                    {
                    match("false"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStatus.g:2224:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalStatus.g:2224:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalStatus.g:2224:11: ( '^' )?
            int alt3=2;
            ...
            // InternalStatus.g:2224:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStatus.g:2226:10: ( ( '0' .. '9' )+ )
            // InternalStatus.g:2226:12: ( '0' .. '9' )+
            {
            // InternalStatus.g:2226:12: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStatus.g:2228:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalStatus.g:2228:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalStatus.g:2228:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalStatus.g:2228:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalStatus.g:2228:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                    ...
                    break;
                case 2 :
                    // InternalStatus.g:2228:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalStatus.g:2228:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStatus.g:2230:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalStatus.g:2230:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalStatus.g:2230:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStatus.g:2232:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalStatus.g:2232:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalStatus.g:2232:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStatus.g:2234:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalStatus.g:2234:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalStatus.g:2234:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt13=0;
            loop13:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStatus.g:2236:16: ( . )
            // InternalStatus.g:2236:18: .
            {
            matchAny(); 
    ...
    static final String[] DFA14_transitionS = {
            "\11\25\2\24\2\25\1\24\22\25\1\24\1\25\1\21\4\25\1\22\4\25\1\6\2\25\1\23\12\15\1\3\6\25\32\20\1\4\1\25\1\5\1\17\1\20\1\25\1\7\1\20\1\12\1\13\1\20\1\16\1\1\4\20\1\2\7\20\1\10\6\20\1\11\1\25\1\14\uff82\25",
            "\1\26\20\uffff\1\27",
            "\1\31",
            "",
            "",
